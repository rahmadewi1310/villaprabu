      ...
      <section class="content">
		...
		<table class="table table-hover" id="dataTable" with="100%" cellspacing="0">
          ...
          <td><?php echo $hasil->STATUS ?></td>
					<td>
						<a href="<?php echo site_url('Booking/edit/'.$hasil->ID_BOOKING) ?>" class="btn btn-sm btn-succes"><i class="fas fa-edit"></i> Update</a>
						<a href="<?php echo site_url('Booking/delete/').$hasil->ID_BOOKING ?>" class="btn btn-small text-danger"><i class="fas fa-trash"></i> Hapus</a>
					</td>
