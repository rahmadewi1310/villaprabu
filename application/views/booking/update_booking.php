  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content">
        <div class="box">
          <form action="<?php echo site_url('booking/update')?>" method="POST">
            <div class="box-body">
              <div class="row">
                <div class="col-sm-4">
                  ...
                  <div class="form-group">
                    		...
                    		<select class="selectpicker form-control" id='tipe' name='ID_KAMAR'>
                    		<option value="0">--Pilih Nomor Kamar--</option>
                    			<?php foreach ($kamar as $key => $value):?>
                    		<option value="<?php echo $value['ID_KAMAR']?>"><?php echo $value['NOMOR_KAMAR']?>
                    		</option>
                    			<?php endforeach; ?>
                    		</select>
                  </div>
