<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li>
        <a href="<?=base_url('admin/book/booking_order')?>">
          <i class="fa fa-tag"></i> <span>Order</span>
        </a>
      </li>
      <li>
      ...
      <li><a href="<?php echo site_url('admin/report/reportkamar') ?>"><i class="fa fa-home"></i>Laporan Kamar</a></li>
