        ...
        <div class="container">
            <div class="row">
              <?php 
                for ($i=0; $i < 10 ; $i++) {
              ?>
                <div class="col-sm-6" style="background-color: #fff; padding: 24px; margin-bottom: 24px;">
                  <div>
                    <div class="row">
                        <div class="col-lg-6">
                        ...
                        <div class="col-lg-6">
                          <h4 class="text-right"><b>Standar Room - 10<?=$i?></b></h4>
                          <h3 class="text-right"><?=number_format(250000)?></h3>
