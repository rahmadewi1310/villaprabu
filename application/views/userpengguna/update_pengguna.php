  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content">
        <div class="box">
          <form action="<?php echo site_url('UserPengguna/update')?>" method="POST">
            <div class="box-body">
              <div class="row">
                <div class="col-sm-4">
                  <input type="hidden" name="ID_ROLE_NAME" value="<?php echo $data_userpengguna->ID_ROLE_NAME; ?>">
                  <div class="form-group">
                    <label>Jenis Pengguna</label>
                    <input type="text" name="ROLE_NAME" value="<?php echo $data_userpengguna->ROLE_NAME?>" class="form-control" >
                  </div>

                  <div class="form-group">
                    <label>Keterangan</label>
                    <input type="text" name="KETERANGAN" value="<?php echo $data_userpengguna->KETERANGAN?>" class="form-control" >
                  </div>
