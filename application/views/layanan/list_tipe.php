      ...
      <section class="content">
        ...
        foreach($layanan as $hasil){
				...
				<tr>
					...
					<td>
						<a href="<?php echo site_url('layanan/edit/'.$hasil->ID_LAYANAN) ?>" class="btn btn-sm btn-succes"><i class="fas fa-edit"></i> Update</a>
						<a href="<?php echo site_url('layanan/delete/').$hasil->ID_LAYANAN ?>" class="btn btn-small text-danger"><i class="fas fa-trash"></i> Hapus</a>
					</td>
