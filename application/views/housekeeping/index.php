...
<head>
  ...
  <?php $this->load->view('template_housekeeping/head') ?>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
    <?php $this->load->view('template_housekeeping/header') ?>
    <?php $this->load->view('template_housekeeping/side') ?>
    <div class="content-wrapper">
      <section class="content">
        <div class="box">
          <form action= 'Housekeeping/Kamar/tambah' method="post" >
            <div class="box-body">
              <div class="row">
                <div class="col-sm-4">
            ...
            <div class="box-footer">
              ...
              <input class="btn btn-success" href="<php echo site_url('Housekeeping/Kamar/tambah')" type="submit" name="btn" value="batal"/>
            </div>
          </form>
        </div>
      </section>
    </div>
    <?php $this->load->view('template_housekeeping/footer') ?>
