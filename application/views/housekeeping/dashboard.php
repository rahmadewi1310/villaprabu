...
<head>
  ...
  <?php $this->load->view('housekeeping/template_housekeeping/head') ?>
...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
   <!--  <?php $this->load->view('housekeeping/template_housekeeping/header') ?>
    <?php $this->load->view('housekeeping/template_housekeeping/side') ?> -->
    <div class="content-wrapper">
      <section class="content">
        <div class="box">
              <?php $this->load->view('housekeeping/dashboard') ?>
