  ...
  <div class="wrapper">
    ...
    <div class="content-wrapper">
      <section class="content">
        <div class="box">
          <form action="<?php echo site_url('Tipekamar/update')?>" method="POST">
            <div class="box-body">
              <div class="row">
                <div class="col-sm-4">
                  <input type="hidden" name="ID_KAMAR_TIPE" value="<?php echo $data_kamartipe->ID_KAMAR_TIPE; ?>"> 
                <div class="row">
                <div class="col-sm-4">
                  <div class="form-group">
                    
                    <label>Nama Tipe Kamar</label>
                    <input class="form-control" name="NAMA_KAMAR_TIPE" required="" value="<?php echo $data_kamartipe->NAMA_KAMAR_TIPE; ?>">
                  </div>
                  <div class="form-group">
                    <label>Harga Malam</label>
                    <input class="form-control" name="HARGA_MALAM" required="" value="<?php echo $data_kamartipe->HARGA_MALAM; ?>">
                  </div>
                  <div class="form-group">
                    <label>Keterangan</label>
                    <textarea  class="form-control" name="KETERANGAN" required="" value="<?php echo $data_kamartipe->KETERANGAN; ?>" ></textarea>
                  </div>
                </div>
              </div>
